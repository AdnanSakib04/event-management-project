...
const NavBar = () => {
    ...
    const navLinks = <>
        ...
        <li><NavLink className={({ isActive, isPending }) =>
            isPending ? "pending" : isActive ? "text-black font-bold bg-base-200 lg:bg-green-300 p-2 rounded-lg" : ""} to="/pastevents">Past Events</NavLink></li>
        <li><NavLink className={({ isActive, isPending }) =>
            isPending ? "pending" : isActive ? "text-black font-bold bg-base-200 lg:bg-green-300 p-2 rounded-lg" : ""} to="/ourspeakers">Our Speakers</NavLink></li>
        <li><NavLink className={({ isActive, isPending }) =>
